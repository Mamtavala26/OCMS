 ...
 <html>  
	...
	<div id="header">
	     <label style="color: black;">Oxygen</label>
          <ul>
               <li><a href="user.php" style="color: black;">Home</a></li>
          </ul>
	</div>
     </header>
           <br />  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td style="text-align:center;";><a class="btn btn-success" href="../admin/buy.php?id=<?php echo $values["item_id"]; ?>&quantity=<?php echo $values["quantity"]; ?>">buy</a></td>
