...
session_start();
 ...
 if(isset($_POST['submit']))
 {
  ...
  $query = "SELECT id, email FROM register WHERE email = '$email' AND password = '$password'";
...
<html lang="en">
  ...
  <div id="header">
      ...
      <br><h2 style="text-align:center; color:white">User Login</h2>
      <form method="POST">
       ...
       <br>Don't have an account?<a class="ridge" href="u_reg.php">New Register here!</a>
     </form>
     </div>
  </body>
