...
<tbody>
    ...
    <tr class="table-danger" >
        ...
        <td><a class="btn btn-success" href="Hospital_cart.php">Buy</a><i class="fas fa-edit"></i></td>
...
<br>
  <div id="footer">
		<div class="foot">
			<label style="font-size:15px; "> Copyright &copy; Oxyegen Cylinder Store. All Rights Reserved. </label><h6 style="font-size:20px;">Developed by: Mamta Vala</h6>
      <p ><button><a href="../msg.php">Feedback</a></button></p>
		</div>
	</div>
  </body>
</html>