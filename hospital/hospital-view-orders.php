...
{
    $id = $_GET['del'];
    $query = "DELETE FROM horder WHERE id= $id";
...
<div class="container mt-3">
  <h2 style="font-size:30px;" align="center">Your Orders</h2>          
  <table class="table table-striped">
    ...
    <tbody>
        ...
        $query = "SELECT a.*,h.name AS Name ,h.mobile AS Mobile ,h.address AS Address FROM add_stock a, horder h WHERE a.id = h.hid ";
        ...
        { 
            ...
            ?>
            <tr>
                <td colspan="9" style="font-size:30px;" align="center">Your orders data record No Found</td>
            </tr>
            <?php
        }
        ?>
