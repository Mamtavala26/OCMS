...
<?php 
  if((isset($_POST['order'])))
  {
    ...
    $query = "INSERT INTO `uorders` (`name`,`email`,`mobile`,`address`,`quantity`,`oid`) VALUES('$name', '$email','$mobile','$address', $quantity,$item_id);";
  ...
  <div id="container1" >
    ...
    <div class="row">
      ...
      <div class="form-group">
       ...
       <br>
       <br><button type="submit" name="order" class="btn btn-success" style="background-color:SteelBlue;">Confirm Order</button>
       <br>
       <br />
     </form>
